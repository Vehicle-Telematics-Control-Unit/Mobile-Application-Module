...
class TyrePressureScreen extends StatelessWidget {
        ...
        builder: (context, constrains) {
          return Stack(
            children: [
              ...
              Padding(
                padding:
                    EdgeInsets.symmetric(vertical: constrains.maxHeight * 0.17),
                child: Center(
                  child: Image.asset(
              ...
              Positioned(
                ...
                child: PressureStatus(tyrePressure: '29.0', tyreTemp: '22C'),
              ),
              Positioned(
                  top: constrains.maxHeight * 0.4,
                  right: constrains.maxWidth * 0.04,
              ...
              Positioned(
                bottom: constrains.maxHeight * 0.3,
                right: constrains.maxWidth * 0.04,
                child: PressureStatus(tyrePressure: '31.0', tyreTemp: '22C'),
              ),
              Positioned(
                  bottom: constrains.maxHeight * 0.4,
                  right: constrains.maxWidth * 0.04,
